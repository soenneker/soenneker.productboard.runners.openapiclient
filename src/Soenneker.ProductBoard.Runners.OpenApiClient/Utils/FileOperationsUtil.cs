...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["ProductBoard:ClientGenerationUrl"] ?? "https://developer.productboard.com/openapi/publicswagger.yaml";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c ProductBoardOpenApiClient -n {Constants.Library}",
